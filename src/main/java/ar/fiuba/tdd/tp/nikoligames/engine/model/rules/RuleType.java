...
public enum RuleType {
    ADDITION("ADDITION"), ADJACENT("ADJACENT"),
    DIAGONAL_PAIR_OF_ADJECENT_GENERATOR("DIAGONAL_PAIR_OF_ADJECENT_GENERATOR"),
    ...
    HORIZONTAL_VERTICAL_PAIR_OF_ADJECENT_GENERATOR("HORIZONTAL_VERTICAL_PAIR_OF_ADJECENT_GENERATOR"),
    HORIZONTAL_VERTICAL_VALID_EDGES_GENERATOR("HORIZONTAL_VERTICAL_VALID_EDGES_GENERATOR"),
    MULTIPLICATION("MULTIPLICACION"),
    NO_CYCLE("NO_CYCLE"), NODE_EDGE_LIST_COUNT("NODE_EDGE_LIST_COUNT"),
