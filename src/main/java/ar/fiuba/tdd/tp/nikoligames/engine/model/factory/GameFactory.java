...
import ar.fiuba.tdd.tp.nikoligames.games.inshiNoHeya.InshiNoHeyaFactory;
...
public class GameFactory {
    ...
    public GameFactory() {
        ...
        this.gamesSettings.put("inshiNoHeya", new GameSetting(new InshiNoHeyaFactory(), "./config/games/kakuro"));
    }
